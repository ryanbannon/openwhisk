...
if(str(sys.argv[1]) == '1'):
    predictions = pd.read_csv('/home/ubuntu/openwhisk/predictions/Experiment_1/experiment_1_2_times.csv')
elif(str(sys.argv[1]) == '2'):
    predictions = pd.read_csv('/home/ubuntu/openwhisk/predictions/Experiment_2/experiment_2_2_times.csv')
else:
    exit()
