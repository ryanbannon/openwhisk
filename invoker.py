...
def serverless_func(experiment,container,function):
    ...
    if(str(experiment) == '1'):
        results = '/home/ubuntu/openwhisk/predictions/Experiment_1/experiment_1_2_results.csv'
    elif(str(experiment) == '2'):
        results = '/home/ubuntu/openwhisk/predictions/Experiment_2/experiment_2_2_results.csv'
    else:
        exit()
